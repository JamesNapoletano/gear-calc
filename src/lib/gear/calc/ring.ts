import { defaultBaseInputs, defaultGearOutputs, type GearOutputs, type RingInputs } from '../types'
...
export const defaults = {
  ...
  addendumCoeff: 1,
  dedendumCoeff: 1.157
} satisfies RingInputs

export const validate = (inputs: RingInputs): string[] => {
...
export const calculate = (rawInputs: RingInputs): GearOutputs => {
