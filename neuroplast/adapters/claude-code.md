...
## Workflow Entrypoint
Read `neuroplast/WORKFLOW_CONTRACT.md`, then execute the current workflow step through the matching instruction file.

## Recommended Prompt
`Execute the Neuroplast workflow from files. Read neuroplast/WORKFLOW_CONTRACT.md, neuroplast/manifest.yaml, neuroplast/capabilities.yaml, and the current instruction file. Follow the contract exactly, keep updates non-destructive, and write outputs only to the documented Neuroplast locations.`
