...
## Workflow Entrypoint
Read the workflow contract and current instruction file before using editor assistance for implementation or planning.

## Recommended Prompt
`Work within the Neuroplast file contract. Read neuroplast/WORKFLOW_CONTRACT.md, neuroplast/manifest.yaml, neuroplast/capabilities.yaml, and the current instruction file. Keep updates non-destructive, preserve required artifact paths, and finish plan, changelog, and learning steps.`
