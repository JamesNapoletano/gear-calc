...
4. Then read and execute the relevant instruction file such as `neuroplast/conceptualize.md` or `neuroplast/act.md`

## Workflow Entrypoint
Start by reading `neuroplast/WORKFLOW_CONTRACT.md`, then follow the relevant instruction file for the current step.

## Recommended Prompt
`You are operating inside a Neuroplast workflow. Read neuroplast/WORKFLOW_CONTRACT.md, neuroplast/manifest.yaml, and the relevant instruction file. Follow the file contract exactly, do not overwrite files unless explicitly instructed, and record plans, changelog updates, and learnings in the designated Neuroplast folders.`
