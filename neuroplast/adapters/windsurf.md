...
## Workflow Entrypoint
Open the workflow contract first, then follow the current Neuroplast instruction file for the active phase.

## Recommended Prompt
`Use the Neuroplast workflow contract as the source of truth. Read neuroplast/WORKFLOW_CONTRACT.md, neuroplast/manifest.yaml, and the current instruction file. Keep all changes within the documented file contract, avoid destructive overwrites, and complete plan, changelog, and learning updates.`
